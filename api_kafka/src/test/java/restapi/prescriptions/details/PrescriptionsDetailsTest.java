...
@CucumberOptions(
        features="src/test/resources/features/prescriptions/details",
        glue = {"restapi.prescriptions.details"},
        plugin = {"pretty","html:target/reports/PrescriptionsDetailsReport.html","json:target/reports/PrescriptionsDetailsReport.json"},
        tags = {"@RealData,~@Ignore"}
)
@Slf4j
public class PrescriptionsDetailsTest {
