...
@CucumberOptions(
        features="src/test/resources/features/doctors/details",
        glue = {"restapi.doctors.details"},
        plugin = {"pretty","html:target/reports/DoctorsDetailsReport.html","json:target/reports/DoctorsDetailsReport.json"},
        tags = {"@RealData"}
)
@Slf4j
public class DoctorsDetailsTest {
    ...
    public static void setup() {
        ...
        // add doctor 2
        jsonObject.remove("surname");
        jsonObject.put("surname","Doctor 2");
