...
@CucumberOptions(
        features="src/test/resources/features/patients/update",
        glue = {"restapi.patients.update"},
        plugin = {"pretty","html:target/reports/PatientsUpdateReport.html","json:target/reports/PatientsUpdateReport.json"},
        tags = {"@RealData"}
)
@Slf4j
public class PatientsUpdateTest {
    ...
    public static void setup() {
        ...
        jsonObject.put("email","testdelete@e2e.com");
        jsonObject.remove("name");
        jsonObject.put("name","Test delete");
