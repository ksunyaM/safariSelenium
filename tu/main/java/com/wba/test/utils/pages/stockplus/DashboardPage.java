...
public class DashboardPage extends LoadableComponent<DashboardPage> {
	...
	@FindBy(id="rx-corp-list-button-5")
	private WebElement returnsIconButton;

	@FindBy(id="logout-button-9999")
	...
	public void clickReturnsIconButton() {
		returnsIconButton.click();
	}
